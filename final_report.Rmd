...
```{r var-label-subject-plot,warning = F, echo = F}
...
do.call(grid.arrange, lapply(names(remove_select_cov_nb)[1:7], varvslab))
```

```{r var-label-subject-plot2,warning = F, echo = F}
do.call(grid.arrange, lapply(names(remove_select_cov_nb)[8:14], varvslab))
```
