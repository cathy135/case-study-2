...
# model with no main effect for Subject but with interactions (there is warning)
pca.model = glm(Label ~ Dim.1+Dim.2+Dim.3+Dim.4+Dim.5+Dim.1:Subject+Dim.2:Subject+Dim.3:Subject+Dim.4:Subject+Dim.5:Subject#+#(1|Subject)#
